      ...
      <div className="admin_demo_toolbar__main">
        <label className="admin_demo_toolbar__search">
          ...
          <input
            ...
            placeholder="Search by name, email, company, solution, phone, message..."
            ...
            <div className="admin_demo_toolbar__filter-panel" role="dialog">
              ...
              <label className="admin_demo_toolbar__field">
                ...
                >
                  ...
                  {DEMO_RECORD_STATUSES.map((status) => (
              ...
              <label className="admin_demo_toolbar__field">
                ...
                <select
                  ...
                  onChange={(event) => onSolutionFilterChange(event.target.value)}
                >
              ...
              <label className="admin_demo_toolbar__field">
                ...
                <select
                  value={coeFilter}
                  onChange={(event) => onCoeFilterChange(event.target.value)}
                >
...
export default AdminDemoTableToolbar;
