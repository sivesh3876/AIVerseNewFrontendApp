...
import { CERTIFICATION_STATUSES } from "../../utils/adminCertificationStorage";

const AdminCertificationStatusDropdown = ({ value = "Active", onChange }) => {
  const [open, setOpen] = useState(false);
  const [menuPosition, setMenuPosition] = useState({ top: 0, left: 0 });
  const triggerRef = useRef(null);
  const menuRef = useRef(null);
  const current = CERTIFICATION_STATUSES.includes(value) ? value : "Active";
...
export default AdminCertificationStatusDropdown;
