...
// Reuses the shared admin action dropdown styling/behaviour (portal + smart
// positioning) for full visual consistency across the panel.
const ActionDropdown = ({ status, onSelect }) => {
  ...
  const options = [
    { id: "view", label: "View" },
    { id: "edit", label: "Edit" },
    { id: "duplicate", label: "Duplicate Role" },
    { id: "manage-permissions", label: "Manage Permissions" },
    { id: "toggle-status", label: isActive ? "Deactivate" : "Activate" },
